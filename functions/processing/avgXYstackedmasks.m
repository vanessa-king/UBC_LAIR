function [masked_data, avg_out, STD_out, comment] = avgXYstackedmasks(data, masks, returnNaNbool)
% averaging I(V) or dIdV data in x and y for the area determined by the
% each layer of the set of stacked masks (eg. output from directional mask)
...
%   masks            stack of logical map of dimension xy matching data
