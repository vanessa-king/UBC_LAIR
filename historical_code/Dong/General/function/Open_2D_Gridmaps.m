%% Header loading
[header, data, par] = load3ds('Grid Spectroscopy007.3ds',0);  % Type your grid file name here
Rxsize=15;
...
for i=1:xsize
for j=1:ysize
    [header, data1, par1] = load3ds('Grid Spectroscopy007.3ds',xsize*(i-1)+(j-1)); % Type your grid file name here
    dIdV(i,j,:,1) = data1(:,2);
    IV(i,j,:,1) = data1(:,1);
end
end 
